        ...
        >
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{slider.selectedSlider.title || "Выберите Слайд"}</Dropdown.Toggle>
                        <Dropdown.Menu>
                            {slider.sliders.map(slide =>
                                <Dropdown.Item
                                    onClick={() => changeData(slide)}
                                    key={slide.id}
                                >
                                    {slide.title}
                                </Dropdown.Item>
                    ...
                    :   
                        ...
                        <Image src={process.env.REACT_APP_API_URL + file}></Image>
            ...
            <Modal.Footer>
                <div className='d-flex flex-row w-100'>
                    ...
                    {!slider.selectedSlider.title ?  <Button variant="outline-success" className='mr-2' onClick={changeSlider} disabled={true}>Изменить</Button> :  <Button variant="outline-success" className='mr-2' onClick={changeSlider}>Изменить</Button> }  

                    {!slider.selectedSlider.title ? <Button variant="outline-danger" onClick={deleteSlide} disabled={true}>Удалить</Button> : <Button variant="outline-danger" onClick={deleteSlide}>Удалить</Button> }
